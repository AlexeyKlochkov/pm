...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@devapollogrp.edu";
#	protected $accountSuffix = "@apollogrp.edu";
    ...
    * @var string
    */
	protected $baseDn = "DC=devapollogrp,DC=edu";
    ...
    * @var array
    */
#    protected $domainControllers = array("rp2-ad.apollogrp.edu");
    protected $domainControllers = array("ad.devapollogrp.edu");
    ...
    * @var string
    */
#    protected $adminUsername = "svc_streamline";
    protected $adminUsername ="svc_devstreamline_LD";
#    protected $adminPassword = "npXUo26q";
    protected $adminPassword = "Y9zr9AaQ";
