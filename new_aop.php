    ...
    <div id = "page">
        ...
        <div id="container">
            <div id="mainContent"> <!--mainContent div tag-->
                <h1>Marketing Project Brief (AOP)</h1>
                <table border = "0" width = "90%">
                    <tr>
                        <td valign="top">
                            <form id = "pif_form" action = "add_aop.php" method = "POST" enctype="multipart/form-data">
                                <div class = "pif_form">
                                    <table>
                                        <tr>
                                            <th colspan = "2">
                                    ...
                                    <tr>
                                        <th colspan = "2">
                                            IV.  MEDIA CHECKLIST * The Standard Lead Times below are general guidelines &loz; each project will be reviewed by a pm to confirm the final timeline, scope and resources available. The clock starts ticking at user-accepted creative brief .
                                        </th>
                                    </tr>
                                    <tr>
                                        <td colspan = "2"
                                    ...
                                    <tr>
                                        <th colspan = "2">
                                            V.  ATTACHMENTS (Spec's, examples, etc.)
                                        </th>
                                    </tr>
                                    <tr>
                                        <td colspan = "2">
