...
function dbConn(){
	$dbConnection = new PDO('mysql:dbname=pm1;host=localhost;charset=utf8', 'haightor_loomis', 'carcharodon');  $dbConnection->setAttribute(PDO::ATTR_EMULATE_PREPARES, false); $dbConnection->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	return $dbConnection;
}