...
$menu .= '
    </ul><div id="Logout" style="left: 85%;position:absolute;"><span style="color: white;padding-top: 3px;">'.strtolower($_SESSION["system_username"]).' </span><a href="loggedout.php"><img src="images/logout.ico"></a></div></div>';
echo $menu;
?>
