...
if (!empty($arr_spend_report)){
	foreach ($arr_spend_report as $spend_row){
			...
			$spend_table .= "<td align = \"right\" nowrap>" .  $spend_date. "</td>";
			...
			$spend_table .= "<td align = \"right\">" .  $current_month_accrue_amount. "</td>";
...
$spend_table .= "</tr><input type = \"hidden\" name = \"campaign_id\" value = \"" . $campaign_id . "\"><input type = \"hidden\" name = \"start_month\" value = \"" . $start_month_year . "\"><input type = \"hidden\" name = \"end_month\" value = \"" . $end_month_year . "\">";
