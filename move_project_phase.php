...
$update1 = update_project_phase_specific_display($project_id, $swap1, 0);

//then set the second one to the first one
$update2 = update_project_phase_specific_display($project_id, $swap2, $swap1);
//then set the first one (which is now zero) to the second one
$update3 = update_project_phase_specific_display($project_id, 0, $swap2);
