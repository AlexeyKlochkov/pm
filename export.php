...
$project_table = "<table width = \"100%\" class = \"stats_table\"><tr><th>#</th><th>Project Code</th><th>Project Name</th><th>AOP Line of Business</th><th>Product</th><th>Status</th><th>IPM</th><th>Brand Manager</th><th>&nbsp;</th></tr>";
if (!empty($arr_projects)){
    foreach ($arr_projects as $project_row){
        $project_id = $project_row["project_id"];
        $arr_project1 = get_project_info($project_id);
       // var_dump($arr_project1);
        ...
        $project_table .= "<td>" . $brand_manager_name . "</td>";
        ...
        <div id="container">
            ...
            <div id="mainContent"> <!--mainContent div tag-->
                ...
                <table class = "small_link" width = "90%">
                    <tr><form id = "get_projects" action = "export.php" method = "GET">
                ...
                <form action = "export1.php" method="POST">
                    ...
                    <input type = "hidden" name = "brand_manager_id" value = "<?php echo $brand_manager_id ?>">
