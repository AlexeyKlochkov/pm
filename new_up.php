        ...
        $(document).ready(function(){
            ...
            $( "#pif_form" ).submit(function( event ) {
                ...
                if(volume_sum == 0){
                    //alert(volume_sum);
                    $("#asset_area").focus();
                    $("#asset_area").html( "<span color = 'red'><b>Please select at least one asset to produce.</b></span>" );
                    return false;
                }
            });
...
<h1>Marketing Project Brief (unplanned activity)</h1>
<table border = "0" width = "90%">
<tr>
<td valign="top">
<form id = "pif_form" action = "add_up.php" method = "POST" enctype="multipart/form-data">
<div class = "pif_form">
<table>
    <tr>
        <th colspan = "2">
    ...
    <tr>
        <td colspan = "2">
            <ul>
                <li><b>Step 1:</b> Complete and submit this form by EOD Thursday. Project Briefs are viewed by Marketing Board every Monday at 10am.</li>
    ...
    <tr>
        <td>Objectives<br><textarea class = "required" type = "text" name = "objectives" rows="6" cols = "60" maxlength="5000"></textarea></td>
        <td>Support Points<br><textarea class = "required" type = "text" name = "support_points" rows="6" cols = "60" maxlength="5000"></textarea></td>
    </tr>
    <tr>
        <td colspan = "2">
    ...
    <tr>
        <th colspan = "2">
            V.  MEDIA CHECKLIST * The Standard Lead Times below are general guidelines &loz; each project will be reviewed by a pm to confirm the final timeline, scope and resources available. The clock starts ticking at user-accepted creative brief .
        </th>
    </tr>
    <tr>
        <td colspan = "2"
    ...
    <tr>
        <td  colspan = "2">Required elements<br><textarea class = "required" type = "text" name = "required_elem" rows="6" cols = "60" maxlength="5000"></textarea></td>
    </tr>
    <tr>
        <th colspan = "2">
            VI. ATTACHMENTS (Spec's, examples, etc.)
        </th>
    </tr>
    <tr>
        <td colspan = "2">
    ...
    <tr>
        <td>
            ...
            <input type = "checkbox" name = "emergency_pb" value = "1">Check this box if this project is an <span style="color:red;">EMERGENCY</span> and someone needs to address it immediately.<br><br>
